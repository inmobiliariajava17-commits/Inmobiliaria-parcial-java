        ...
        <div class="surface-card mb-4">
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="<%= request.getContextPath() %>/citas-inmobiliaria" class="btn btn-sm <%= request.getParameter("estado") == null ? "btn-primary" : "btn-outline-primary" %>">Todas</a>
                    <a href="<%= request.getContextPath() %>/citas-inmobiliaria?estado=PENDIENTE" class="btn btn-sm <%= "PENDIENTE".equals(request.getParameter("estado")) ? "btn-primary" : "btn-outline-primary" %>">Pendientes</a>
                    <a href="<%= request.getContextPath() %>/citas-inmobiliaria?estado=CONFIRMADA" class="btn btn-sm <%= "CONFIRMADA".equals(request.getParameter("estado")) ? "btn-primary" : "btn-outline-primary" %>">Confirmadas</a>
                    <a href="<%= request.getContextPath() %>/citas-inmobiliaria?estado=REALIZADA" class="btn btn-sm <%= "REALIZADA".equals(request.getParameter("estado")) ? "btn-primary" : "btn-outline-primary" %>">Realizadas</a>
                    <a href="<%= request.getContextPath() %>/citas-inmobiliaria?estado=CANCELADA" class="btn btn-sm <%= "CANCELADA".equals(request.getParameter("estado")) ? "btn-primary" : "btn-outline-primary" %>">Canceladas</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="surface-card h-100">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                <% if ("PENDIENTE".equals(estado)) { %>
                                    <form method="post" action="<%= request.getContextPath() %>/citas-inmobiliaria" class="d-inline">
