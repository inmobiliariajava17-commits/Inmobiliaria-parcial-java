...
<head>
    ...
    <title>Catálogos - Administrador</title>
</head>
<body>
...
<main class="page-wrap">
    <div class="container app-container">
        ...
        <% } else if ("bd".equals(error)) { %>
            <div class="alert alert-danger">No se pudo completar la operación en la base de datos.</div>
        <% } %>
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="surface-card h-100">
                    ...
                    <form method="post" action="<%= request.getContextPath() %>/administrador/catalogos" class="mb-4">
                    ...
                    <div class="catalog-list">
                        <% for (Map<String, Object> item : ciudades) { %>
                            <div class="catalog-row">
                                <form method="post" action="<%= request.getContextPath() %>/administrador/catalogos" class="d-flex gap-2 flex-grow-1">
                                    <input type="hidden" name="catalogo" value="ciudad">
                                ...
                                <form method="post" action="<%= request.getContextPath() %>/administrador/catalogos">
                                    <input type="hidden" name="catalogo" value="ciudad">
        ...
        <div class="info-panel mt-4">
            ...
            <p class="mb-0">Los catálogos tienen restricciones de integridad en la base de datos. Si una ciudad, tipo o característica ya está relacionada con otros registros, PostgreSQL impedirá su eliminación.</p>
        </div>
    </div>
</main>
